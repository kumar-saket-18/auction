...
from .views import add_player_to_team, dashboard, get_tc_falcons_list, get_tc_eagles_list, get_tc_hawks_list, history, generate_random_player, mark_unsold, generate_random_unsold_player
...
urlpatterns = [
    ...
    path('get-tc-falcons-player-list/', get_tc_falcons_list, name='get-tc-falcons-player-list'),
